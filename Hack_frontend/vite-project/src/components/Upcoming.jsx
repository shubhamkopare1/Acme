...
const Upcoming = () => {
    ...
    return (
        ...
        <div className="w-full h-full max-w-6xl mx-auto grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
         ...
         >
                    ...
                    {/* Event Image */}
                    <img src={event.img} alt={event.title} className="w-full object-cover rounded-md" />
    ...
    <span className="flex items-center gap-1">
        📍 {event.location}
                        ...
                        {/* Button */}
                        <button className="mt-4 border border-green-300 text-green-400 px-6 py-2 rounded-md w-full font-semibold tracking-wide transition duration-300 hover:bg-green-400 hover:text-white"
